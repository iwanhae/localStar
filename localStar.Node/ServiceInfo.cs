...
namespace localStar.Node
{
    public class ServiceInfo : ISerializable
    {
        ...
        public ServiceInfo(string name, IPEndPoint address, NodeInfo Parent = null, int delay = 0){
            this.name = name;
        ...
        public void setParent(NodeInfo Parent) => this.Parent = Parent;
        ...
        public ServiceInfo(SerializationInfo info, StreamingContext context)
        {
